...
setwd("C:/Users/cloke/Documents/M - UBC/Courses/MICB 475/475_Group_Project/Aim_1_jacaard")
...
for (i in 1:61){                                #COMPLETE the for loop argument. You need to to loop through as many variables that are present in "nutrients". Use a range, IE (1:?)
  ...
  dis = vegdist(ASV_mat, method = "jaccard",diag =T, upper = T) #Create the distance matrix based on a bray-curtis dissimilarity model
...
for (i in 1:61){                                #COMPLETE the for loop argument. You need to to loop through as many variables that are present in "nutrients". Use a range, IE (1:?)
  ...
  # I did this earlier ASV_mat = t(ASV_mat +1) # Transpose the ASV matrix so that the sample IDs become rownames. This is required for  adonis2()
  dis = vegdist(ASV_matp, method = "jaccard",diag =T, upper = T) #Create the distance matrix based on a bray-curtis dissimilarity model
...
for (i in 1:61){                                #COMPLETE the for loop argument. You need to to loop through as many variables that are present in "nutrients". Use a range, IE (1:?)
  ...
  # I did this earlier ASV_mat = t(ASV_mat +1) # Transpose the ASV matrix so that the sample IDs become rownames. This is required for  adonis2()
  dis = vegdist(ASV_matc, method = "jaccard",diag =T, upper = T) #Create the distance matrix based on a bray-curtis dissimilarity model
