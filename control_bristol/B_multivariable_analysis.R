...
setwd("C:/Users/cloke/Documents/M - UBC/Courses/MICB 475/475_Group_Project/Aim_1/control_bristol")
...
pd_rare_b <- subset_samples(pd_rare, Bristol < 4.5)
...
for (i in 1:61){                                #COMPLETE the for loop argument. You need to to loop through as many variables that are present in "nutrients". Use a range, IE (1:?)
  ...
  adonis.res_a[[i]] = vegan::adonis2(as.formula(paste("dis~",nutrients_a[[i]],sep = "")), data = meta_df_a, permutations = 10000) #This line runs the PERMANOVA test and puts it into the empty list we made above.
}
...
for (i in 1:61){                                #COMPLETE the for loop argument. You need to to loop through as many variables that are present in "nutrients". Use a range, IE (1:?)
  ...
  adonis.res_pd[[i]] = vegan::adonis2(as.formula(paste("dis~",nutrients_pd[[i]],sep = "")), data = meta_df_pd, permutations = 10000) #This line runs the PERMANOVA test and puts it into the empty list we made above.
}
...
for (i in 1:61){                                #COMPLETE the for loop argument. You need to to loop through as many variables that are present in "nutrients". Use a range, IE (1:?)
  ...
  adonis.res_c[[i]] = vegan::adonis2(as.formula(paste("dis~",nutrients_c[[i]],sep = "")), data = meta_df_c, permutations = 10000) #This line runs the PERMANOVA test and puts it into the empty list we made above.
}
